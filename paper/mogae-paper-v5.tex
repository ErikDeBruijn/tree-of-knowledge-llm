...
A preliminary experiment with learntropy-modulated per-expert LR shows
clear differentiation: experts naturally enter assimilation mode (learntropy
$\sim$2.3, LR $\to$ 1.8$\times 10^{-6}$) or accommodation mode (learntropy
$\sim$4.5, LR $\to$ 2.1$\times 10^{-5}$) without manual intervention.
