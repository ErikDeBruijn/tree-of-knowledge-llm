...
\begin{enumerate}
    ...
    \item \textbf{Split timing is scheduled, not learntropy-driven.}
          ...
          The scheduled approach works well in practice and the cadence
          can be made adaptive (split when global loss improvement stalls),
          but this is a heuristic rather than the principled learntropy
          signal envisioned in the framework.
