...
\textbf{Results.} (1)~Attention gates show strong selectivity ($+0.756$),
even exceeding FFN ($+0.62$). Attention patterns \emph{are}
function-specific. (2)~Combined FFN+attention does not improve domain PPL
($1.07$ in both cases), but attention gates \emph{protect} generic
capability: degradation drops from $+7.4\%$ to $-1.6\%$. FFN provides
