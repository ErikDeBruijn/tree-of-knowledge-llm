...
The trunk occupies a fixed DRAM footprint regardless of how many specialists
exist. The bulk of crystallized knowledge lives on cheap flash storage, not
expensive DRAM. Combined with trunk quantization (which reduces the trunk's
memory footprint further), the total system can host thousands of domain
adapters while fitting in consumer-grade hardware. Quantization and adapters
are multiplicatively efficient: a 4-bit trunk in 4\,GB + 100 adapters on
flash = vast knowledge on modest hardware.
