...
Substantial & Rank-64 LoRA & 256\,KB & NVMe (instant load) \\
Fundamental (crystal) & Full expert & 12\,MB & NVMe (prefetchable) \\
\bottomrule
\end{tabular}
\end{table}
