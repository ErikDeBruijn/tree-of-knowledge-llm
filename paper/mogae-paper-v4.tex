...
Domain selectivity ($M_{ij}$ CV) plateaus at $\sim$0.16 regardless of expert
count (2--48 tested), suggesting the bottleneck is the base model's
representational capacity at 1.7B parameters, not the number of experts.
\end{abstract}
