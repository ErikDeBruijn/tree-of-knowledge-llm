...
uniformly rather than selectively---confirming that the training signal, not
the architecture, is the binding constraint on causal locality.
...
RCR = PPL gain / trainable parameters in millions. Higher RCR = more
