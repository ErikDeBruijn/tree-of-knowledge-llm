...
toward but not yet achieving domain selectivity. Fitting a power law to CV
vs.\ expert count yields $\text{CV} \approx 0.105 \cdot N^{0.16}$: the
exponent is very shallow, predicting $\sim$50 experts for CV$=$0.2 and
$\sim$600 for CV$=$0.3---consistent with Monet's extreme expert
counts~\cite{monet2025}.
