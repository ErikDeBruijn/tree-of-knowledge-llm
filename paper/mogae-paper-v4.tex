...
many more, smaller experts. The current binary forking (1$\to$2) is a design
choice, not a constraint: multi-furcation (1$\to$N children) could exploit
multimodal learntropy distributions directly, echoing the extreme expert
counts that enable domain specialization in
Monet~\cite{monet2025}.
