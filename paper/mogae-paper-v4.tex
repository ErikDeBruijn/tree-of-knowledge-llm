...
\begin{enumerate}[nosep]
    ...
    \item \textbf{Causal modularity.} Removing an expert causes
          \emph{selective} damage---its domain or function degrades while others
          are unaffected. This is the requirement for hot-pluggability. Measured
          by the ablation matrix $M_{ij}$, not by weight geometry.
\end{enumerate}
...
populations requiring different corrections), splitting is appropriate. Rank
growth adds capacity within one factor; splitting separates factors into
independently trainable units.
