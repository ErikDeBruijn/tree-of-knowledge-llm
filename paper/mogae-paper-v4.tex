...
A damage-prediction surrogate that directly optimizes for selective
indispensability achieves token-level exclusivity but not domain-level
selectivity, suggesting the path to causal locality lies in optimization (router learning
...
training signal at this scale and data composition. A top-2 routing variant
