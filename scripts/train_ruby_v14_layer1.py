#!/usr/bin/env python3
"""V14: LoRA+ from layer 1 rank-16 with deterministic 20-prompt eval, 250-step checkpointing.
...
def main():
    ...
    print("=== V14: LoRA+ from layer 1 rank-16 deterministic 20-prompt eval ===")
    ...
    with open("/root/t6b-mogae/results/ruby_v14_layer1.json", "w") as f:
        json.dump({
    ...
    print("Saved to results/ruby_v14_layer1.json")
