#!/usr/bin/env python3
"""V10: LoRA+ rank-32 with deterministic 20-prompt eval, 250-step checkpointing.
...
def main():
    ...
    print("=== V10: LoRA+ rank-32 deterministic 20-prompt eval ===")
    ...
    with open("/root/t6b-mogae/results/ruby_v10_eval.json", "w") as f:
        json.dump({
    ...
    print("Saved to results/ruby_v10_eval.json")
