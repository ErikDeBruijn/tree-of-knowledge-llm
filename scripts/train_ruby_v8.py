#!/usr/bin/env python3
"""V8: LoRA+ with deterministic 20-prompt eval, 250-step checkpointing.
...
def main():
    ...
    print("=== V8: LoRA+ deterministic 20-prompt eval ===")
    ...
    with open("/root/t6b-mogae/results/ruby_v8_eval.json", "w") as f:
        json.dump({
    ...
    print("Saved to results/ruby_v8_eval.json")
