...
- Joint gate training: gate frozen (2026-04-03, v11 bias=-3, v12 bias=-1): Gate value stays exactly at sigmoid(init_bias) throughout training. Neither bias=-3 (gate=0.047) nor bias=-1 (gate=0.270) shows any learning. Adapter absorbs all gradient signal. The gate needs a separate training phase or alternating optimization to learn.
