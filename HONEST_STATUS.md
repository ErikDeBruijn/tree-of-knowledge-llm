...
- E2E benchmark: grove improves standard benchmarks (2026-03-30, 2 configurations): Non-joint gates: ARC 57.51% (+1.2%), HellaSwag 77.52% (+2.6%). Joint-trained gates: ARC 57.34% (+1.0%), HellaSwag 77.06% (+2.1%). Both configurations improve over base (56.31%/74.95%). Improvement is robust across gate configurations — adapters themselves help, not routing precision. 0-shot. SUPPORTED (2 configurations, both above base, HellaSwag improvement >5 sigma).
